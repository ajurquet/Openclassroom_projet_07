...
def csv_to_list_and_clean_datas(csv_file):
    ...
    #     r[1] = int(float(r[1]) * 100)
    #     r[2] = int(float(r[2]) * 100)

    #     if r[1] > 0 and r[2] > 0:
    #         dataset_clean.append(r)
    # return dataset_clean
    ...
    for l in range(1, len(donnees) + 1):
        ...
        for c in range(1, depense_max + 1):
            ...
            if donnees[l-1][1] <= c: 
                ...
                """
                Je rentre dans la matrice le maximum entre :
...
# print(csv_to_list_and_clean_datas('data/dataset1_Python+P7.csv'))
# print(dynamic(500, donnees))
