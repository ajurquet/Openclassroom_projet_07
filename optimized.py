...
print(dynamic(50000, csv_to_list_and_clean_datas('data/dataset1_Python+P7.csv')))
print(dynamic(50000, csv_to_list_and_clean_datas('data/dataset2_Python+P7.csv')))

print(dynamic_with_sienna_datas('data/solution1_Python+P7.txt', 'data/dataset1_Python+P7.csv'))
print(dynamic_with_sienna_datas('data/solution2_Python+P7.txt', 'data/dataset2_Python+P7.csv'))
